...
class Options(QMainWindow):
 ...
 def __init__(self, parent=None):
    ...
    btn1=QPushButton("Activity Tracking",self)
...
class actTracker(QMainWindow):
  ...
  def __init__(self,parent=None):
    ...
    lbl1=QLabel('Enter name(s) of Input file(s) separated by spaces')
    ...
    self.grid.addWidget(btn,4,2,1,7,QtCore.Qt.AlignLeft)
